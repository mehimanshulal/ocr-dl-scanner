...
var ImageCropperComponent = class _ImageCropperComponent {
  ...
  constructor(sanitizer, cd, zone) {
    ...
    this.cd = cd;
    this.zone = zone;
    this.pinchStart$ = new import_rxjs.Subject();
  ...
  initMouseMove() {
    (0, import_rxjs.merge)((0, import_rxjs.fromEvent)(document, "mousemove"), (0, import_rxjs.fromEvent)(document, "touchmove")).pipe((0, import_operators.takeUntil)((0, import_rxjs.merge)((0, import_rxjs.fromEvent)(document, "mouseup"), (0, import_rxjs.fromEvent)(document, "touchend"), this.pinchStart$).pipe((0, import_operators.first)()))).subscribe({
  ...
  initPinch() {
    ...
    (0, import_rxjs.fromEvent)(document, "touchmove").pipe((0, import_operators.takeUntil)((0, import_rxjs.fromEvent)(document, "touchend"))).subscribe({
      next: (event) => this.zone.run(() => {
